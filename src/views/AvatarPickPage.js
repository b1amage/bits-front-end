...
const AvatarPickPage = () => {
  ...
  return (
    <Container className="flex flex-col items-center">
      ...
      <form onSubmit={(e) => e.preventDefault()} className="my-10 lg:my-16">
      ...
      {showMessage && (
        <Text className="my-10">Please check your email for confirmation</Text>
      )}

      <Button className="md:w-full md:py-5" primary onClick={handleRegister}>
        Register
      </Button>
    </Container>
  );
